...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--name', type=str, default='y+bo+dyt+mpre1', help='name of the experiment.')
        parser.add_argument('--model', type=str, default='pluralistic', help='name of the model type. [pluralistic]')
        parser.add_argument('--mask_type', nargs='+', type=int, default=[0,1,2,3],
                             help='mask type, 0: center mask, 1:random regular mask,'
                             '2: random irregular mask. 3: external irregular mask. [0],[1,2],[1,2,3]')
        parser.add_argument('--checkpoints_dir', type=str, default='/data/student/LJ/wsa-former-main/checkpoints', help='models are save here')
        ...
        parser.add_argument('--img_file', type=str, default='/data/student/LJ/DhMurals-inpainting/train/images', help='training and testing dataset')
        parser.add_argument('--mask_file', type=str, default='/data/student/LJ/DhMurals-inpainting/train/masks', help='load test mask')
